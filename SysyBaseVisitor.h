...
public:
    ...
    virtual std::any visitDecl(SysyParser::DeclContext* ctx) override { return visitChildren(ctx); }
    ...
    virtual std::any visitInt(SysyParser::IntContext* ctx) override { return visitChildren(ctx); }
    ...
    virtual std::any visitInit(SysyParser::InitContext* ctx) override { return visitChildren(ctx); }
    ...
    virtual std::any visitVoid(SysyParser::VoidContext* ctx) override { return visitChildren(ctx); }
    ...
    virtual std::any visitExp(SysyParser::ExpContext* ctx) override { return visitChildren(ctx); }

    virtual std::any visitCond(SysyParser::CondContext* ctx) override { return visitChildren(ctx); }

    virtual std::any visitLVal(SysyParser::LValContext* ctx) override { return visitChildren(ctx); }
    ...
    virtual std::any visitCall(SysyParser::CallContext* ctx) override { return visitChildren(ctx); }
    ...
    virtual std::any visitNot(SysyParser::NotContext* ctx) override { return visitChildren(ctx); }
    ...
    virtual std::any visitDiv(SysyParser::DivContext* ctx) override { return visitChildren(ctx); }

    virtual std::any visitMod(SysyParser::ModContext* ctx) override { return visitChildren(ctx); }

    virtual std::any visitMul(SysyParser::MulContext* ctx) override { return visitChildren(ctx); }
    ...
    virtual std::any visitAdd(SysyParser::AddContext* ctx) override { return visitChildren(ctx); }

    virtual std::any visitSub(SysyParser::SubContext* ctx) override { return visitChildren(ctx); }

    virtual std::any visitGeq(SysyParser::GeqContext* ctx) override { return visitChildren(ctx); }

    virtual std::any visitLt(SysyParser::LtContext* ctx) override { return visitChildren(ctx); }
    ...
    virtual std::any visitLeq(SysyParser::LeqContext* ctx) override { return visitChildren(ctx); }

    virtual std::any visitGt(SysyParser::GtContext* ctx) override { return visitChildren(ctx); }

    virtual std::any visitNeq(SysyParser::NeqContext* ctx) override { return visitChildren(ctx); }

    virtual std::any visitEq(SysyParser::EqContext* ctx) override { return visitChildren(ctx); }
    ...
    virtual std::any visitAnd(SysyParser::AndContext* ctx) override { return visitChildren(ctx); }

    virtual std::any visitOr(SysyParser::OrContext* ctx) override { return visitChildren(ctx); }
